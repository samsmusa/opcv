...
urlpatterns = [
    ...
    path("api/student-list/<int:temp_exam_master_id>/<int:section_id>/<int:subject_id>/", views.StudentList.as_view(), name='student-list'),
    path("api/omr-scan/", views.OmrScan.as_view(), name='omr-scan'),
